...
#         self.source_encoder.add_module('ps_LeakyReLU3', nn.LeakyReLU(True))
#         self.source_encoder.add_module('ps_linear4', nn.Linear(256, 512))
#         self.source_encoder.add_module('ps_LeakyReLU4', nn.LeakyReLU(True))
#         self.source_encoder.add_module('ps_linear5', nn.Linear(512, 256))
#         self.source_encoder.add_module('ps_LeakyReLU5', nn.LeakyReLU(True))
#         self.source_encoder.add_module('ps_linear6', nn.Linear(256, 128))
#         self.source_encoder.add_module('ps_LeakyReLU6', nn.LeakyReLU(True))
#         self.source_encoder.add_module('ps_linear7', nn.Linear(128, 64))
#         self.source_encoder.add_module('ps_LeakyReLU7', nn.LeakyReLU(True))
...
#         self.target_encoder.add_module('pt_LeakyReLU3', nn.LeakyReLU(True))        
#         self.target_encoder.add_module('pt_linear4', nn.Linear(256, 512))
#         self.target_encoder.add_module('pt_LeakyReLU4', nn.LeakyReLU(True))
#         self.target_encoder.add_module('pt_linear5', nn.Linear(512, 256))
#         self.target_encoder.add_module('pt_LeakyReLU5', nn.LeakyReLU(True))
#         self.target_encoder.add_module('pt_linear6', nn.Linear(256, 128))
#         self.target_encoder.add_module('pt_LeakyReLU6', nn.LeakyReLU(True))
#         self.target_encoder.add_module('pt_linear7', nn.Linear(128, 64))
#         self.target_encoder.add_module('pt_LeakyReLU7', nn.LeakyReLU(True))
...
#         self.shared_encoder.add_module('sc_LeakyReLU3', nn.LeakyReLU(True))
#         self.shared_encoder.add_module('sc_linear4', nn.Linear(256, 512))
#         self.shared_encoder.add_module('sc_LeakyReLU4', nn.LeakyReLU(True))
#         self.shared_encoder.add_module('sc_linear5', nn.Linear(512, 256))
#         self.shared_encoder.add_module('sc_LeakyReLU5', nn.LeakyReLU(True))
#         self.shared_encoder.add_module('sc_linear6', nn.Linear(256, 128))
#         self.shared_encoder.add_module('sc_LeakyReLU6', nn.LeakyReLU(True))
#         self.shared_encoder.add_module('sc_linear7', nn.Linear(128, 64))
#         self.shared_encoder.add_module('sc_LeakyReLU7', nn.LeakyReLU(True))
...
#         self.shared_encoder_pred_domain.add_module('pd_softmax', nn.LogSoftmax(dim=1))
